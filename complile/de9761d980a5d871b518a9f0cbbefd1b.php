...
<head>
  ...
  <link rel="stylesheet" href="<?php echo APP_THEME_DIR;?>/layui/css/layui.css?v=v2.3.0">
  <link rel="stylesheet" href="<?php echo APP_THEME_DIR;?>/font-awesome/css/font-awesome.min.css?V4.7.0" type="text/css">
  <link rel="stylesheet" href="<?php echo APP_THEME_DIR;?>/css/comm.css?v=v1.3.6">
          ...
          <dl class="layui-nav-child">
			<?php if ($value->mcode=='M130') {?>
				 <?php $num3 = 0;foreach ($this->getVar('menu_models') as $key3 => $value3) { $num3++;?>
				 	<?php if ($value3->type==1 && $value3->mcode==1) {?>
						<dd><a href="<?php echo \core\basic\Url::get('/admin/Single/index');?>"><i class="fa fa-file-text-o" aria-hidden="true"></i><?php echo $value3->name; ?>内容</a></dd>
					<?php } ?>
...
<div class="layui-body">
	...
	<div class="layui-tab layui-tab-brief" lay-filter="tab">
	  <ul class="layui-tab-title">
	    <li class="layui-this" lay-id="t1"><?php echo $this->getVar('model_name');?>列表</li>
	  ...
	  <div class="layui-tab-content">
		            ...
		            <table class="layui-table">
		                ...
		                <tbody>
		                    ...
		                    <tr>
		                        ...
		                        <td title="<?php echo $value->scode; ?>"><?php echo $value->sort_name; ?></td>
		                        ...
		                        <td>
		                        	<a href="<?php echo \core\basic\Url::get('/home/content/index/id/'.$value->id.'');?>?nocache=1" class="layui-btn layui-btn-xs layui-btn-primary"  target="_blank">查看</a>
		                            <?php echo get_btn_del($value->id);?>
		                            <?php if (check_level('mod')) {?>
		                            	<a href="<?php echo \core\basic\Url::get('/admin/Content/mod/mcode/'.get('mcode').'/id/'.$value->id.'');?>?backurl=<?php echo $this->getVar('backurl');?>" class="layui-btn layui-btn-xs" >修改</a>
		                            <?php } ?>
		                        </td>
		                    </tr>
		                    <?php } ?>
	  	   ...
	  	   <div class="layui-tab-item">
	  	  		<form action="<?php echo \core\basic\Url::get('/admin/Content/add/mcode/'.get('mcode').'');?>?<?php echo escape_string($_SERVER['QUERY_STRING']);?>" method="post" class="layui-form" lay-filter="content" id="edit">
		  	     	<input type="hidden" name="formcheck" value="<?php echo $this->getVar('formcheck');?>" > 
		  	     	<div class="layui-tab">
					  <ul class="layui-tab-title">
					  ...
					  <div class="layui-tab-content">
					    <div class="layui-tab-item layui-show">
					    	<div class="layui-form-item">
			                     <label class="layui-form-label">内容栏目</label>
			                ...
			                <div class="layui-form-item">
			                     ...
			                     <button type="button" class="layui-btn uploads" data-des="pics">
					    ...
					    <div class="layui-tab-item ">
			                ...
			                <div class="layui-form-item">
			                     ...
			                     <div class="layui-input-block">
			                     	<input type="text" name="keywords" placeholder="请输入内容页SEO关键字" class="layui-input">
			                     </div>
			                </div>
			                ...
			                <div class="layui-form-item">
			                     ...
			                     <div class="layui-input-block">
			                     	<textarea name="description" placeholder="请输入内容页SEO描述" class="layui-textarea"></textarea>
			                     </div>
			                </div>
	...
	<div class="layui-tab layui-tab-brief" lay-filter="tab">
	  ...
	  <div class="layui-tab-content">
	  	<div class="layui-tab-item layui-show">
	  		<form action="<?php echo \core\basic\Url::get('/admin/Content/mod/id/'.get('id').'');?>?<?php echo escape_string($_SERVER['QUERY_STRING']);?>" method="post" class="layui-form" id="edit">
	  			<input type="hidden" name="formcheck" value="<?php echo $this->getVar('formcheck');?>" > 
	  			<div class="layui-tab">
					  <ul class="layui-tab-title">
					    <li class="layui-this">基本内容</li>
					    ...
					    <div class="layui-tab-item ">
					    	<div class="layui-form-item">
			                 ...
			                 <div class="layui-form-item">
			                     <label class="layui-form-label">自定义路径名</label>
			                     <div class="layui-input-block">
			                     	<input type="text" name="filename" value="<?php echo @$this->getVar('content')->filename;?>" placeholder="请输入自定义路径名，如:test" class="layui-input">
			                     </div>
			                 </div>
			                ...
			                <div class="layui-form-item">
			                     <label class="layui-form-label">SEO关键字</label>
			                     <div class="layui-input-block">
			                     	<input type="text" name="keywords" value="<?php echo @$this->getVar('content')->keywords;?>"  placeholder="请输入内容页SEO关键字" class="layui-input">
			                     </div>
			                </div>
			                ...
			                <div class="layui-form-item">
			                     <label class="layui-form-label">SEO描述</label>
			                     <div class="layui-input-block">
			                     	<textarea name="description" placeholder="请输入内容页SEO描述" class="layui-textarea"><?php echo @$this->getVar('content')->description;?></textarea>
			                     </div>
			                </div>
...
<!-- 引入编辑器文件 -->
<script type="text/javascript" charset="utf-8" src="<?php echo CORE_DIR;?>/extend/ueditor/ueditor.config.js?v=1.3.5"></script>
<script type="text/javascript" charset="utf-8" src="<?php echo CORE_DIR;?>/extend/ueditor/ueditor.all.min.js?v=1.3.5"> </script>
...
<script type="text/javascript">editor_init();</script>
  ...
  <div class="layui-footer">
    <!-- 底部固定区域 -->
    &copy; <a href="http://www.pbootcms.com" target="_blank">pbootcms.com</a> - <a href="http://www.hnaoyun.com" target="_blank">翱云科技版权所有.</a>
  	<span class="layui-hide-xs">{pboot:runtime}</span>
  </div>
</div>

<script type="text/javascript" src="<?php echo APP_THEME_DIR;?>/layui/layui.all.js?v=v2.4.5"></script>
<script type="text/javascript" src="<?php echo APP_THEME_DIR;?>/js/comm.js?v=v1.3.6"></script>
<script type="text/javascript" src="<?php echo APP_THEME_DIR;?>/js/mylayui.js?v=v1.3.5"></script>
...
<?php return array (
  0 => 'C:/Shubinqi/wwwroot/blog.syabq.cn_765tm6/web/apps/admin/view/default/common/head.html',
  1 => 'C:/Shubinqi/wwwroot/blog.syabq.cn_765tm6/web/apps/admin/view/default/common/ueditor.html',
  2 => 'C:/Shubinqi/wwwroot/blog.syabq.cn_765tm6/web/apps/admin/view/default/common/foot.html',
); ?>