  ...
  <div class="col-300">
      ...
      <div class="swiper-wrapper">
        {pboot:slide num=5 gid=1}
          <div class="swiper-slide">
            ...
            <div class="container">
              <div class="position-absolute text-light" style="top:30%; left: 10%;">
      ...
      <div class="container">
        <div class="article-index">
          <div class="col-sm-12 box-title">
            <h3 class="fw700">最新文章<span class="fr wow fadeInDown" data-wow-delay="1s">{pboot:sort scode=5}
                <a href="[sort:link]" class="text-secondary fs-14 fs-sm-16">查看更多</a>
              {/pboot:sort}</span></h3>
          </div>
          {pboot:list scode=5 num=4 order=date}
          <div class="box-article col-sm-12  wow fadeInUp" data-wow-delay="[list:i]00ms" data-wow-duration="1s">
            <div class="box-card">
    ...
    <div class="row">
      <div class="container">
        <div class="article-index">
          <div class="col-sm-12 box-title">
            <h3 class="fw700">前端随笔<span class="fr wow fadeInDown" data-wow-delay="1s">{pboot:sort scode=2}
              <a href="[sort:link]" class="text-secondary fs-14 fs-sm-16">查看更多</a>
              {/pboot:sort}</span></h3>
          </div>
            <!-- {pboot:sort scode=2}
            ...
            {pboot:list scode=2 num=4 order=date}
              <div class="box-article col-sm-12 wow fadeInUp" data-wow-delay="100ms" data-wow-duration="1s">
                <div class="box-card">
                  <div class="card-title fw700">
...
<div class="col300 hidden-xs slidebar">
    ...
    <!-- 标签云 -->
    <div class="panel panel-default wow fadeInRight" data-wow-delay="400ms" data-wow-duration="1s">
        <div class="panel-heading">
            <h1 class="panel-title">标签云</h1>
        </div>
        <div class="panel-body label">
            <!-- 标签-->
            {pboot:list scode=2,5 num=20 order=sorting}
                {pboot:tags id=[list:id] scode={sort:tcode}}
                    <a href="[tags:link]"><span class="btn btn-info">[tags:text]</span></a>
                {/pboot:tags}
            {/pboot:list}
        </div>
    </div>
    ...
    <div class="panel panel-default wow fadeInRight" data-wow-delay="600ms" data-wow-duration="1s">
        ...
        <div class="panel-body friend-slide">
            <!-- 好友位-->
            {pboot:link gid=2}
                <span><a href="[link:link]" title="[link:name]" target="_blank"><span>[link:name]</span></a></span>
            {/pboot:link}
            <div class="clear"></div>
        </div>
    </div>
...
<?php return array (
  ...
  1 => 'C:/Shubinqi/wwwroot/blog.syabq.cn_765tm6/web/template/default/comm/slideall.html',
  2 => 'C:/Shubinqi/wwwroot/blog.syabq.cn_765tm6/web/template/default/comm/foot.html',
); ?>